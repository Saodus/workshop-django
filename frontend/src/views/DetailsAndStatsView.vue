...
<template>
  ...
  <q-page padding>
    <q-select v-model="user" @update:model-value="updateVal" class="q-mb-lg" option-value="id" option-label="username"
      :options="users" label="User" filter="1" outlined />
    <div class="row">
      <div class="col-12 offset-md-2 col-md-8">
        <q-card class="q-mb-lg">
          ...
          <div v-if="user">
            <q-table :pagination="initialPagination" :rows="currentRows" :columns="columns" row-key="name"></q-table>
            <q-card-section class="text-center">
            ...
            <q-card-section class="text-center">
              <q-banner inline-actions class="text-white bg-primary">
                ...
                <div class="text-right">
                  ...
                  <q-btn color="grey-9" target="_blank" href="https://www.hsph.harvard.edu/nutritionsource/caffeine/">
                    More details
        ...
        <q-table :pagination="initialPagination" :rows="rows" :columns="columns" row-key="name">
          <template #body-cell-id="props">
            <q-td key="id" :props="props">
              <q-btn @click="remove(props.row.id)" class="q-ma-xs" color="negative" icon="mdi-delete" dense /> </q-td>
          </template>
        </q-table>
      </div>
    </div>
