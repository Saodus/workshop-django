...
<template>
  ...
  <q-select v-model="user" option-value="id" option-label="username" :options="users" label="User" outlined />
  ...
  <q-page padding>
    ...
    <div class="row">
      <div class="text-center col-12 col-sm-6 col-md-4 col-lg-3 q-pa-sm" v-for="(item, index) in TODOcaffeine"
        :key="index">
